...
public class Rigidbody2DMoveController : MonoBehaviour {
    ...
    public delegate void CallbackEvent(Rigidbody2DMoveController controller);
    public delegate void CollisionCallbackEvent(Rigidbody2DMoveController controller, Collision2D col);
    public delegate void TriggerCallbackEvent(Rigidbody2DMoveController controller, Collider2D col);
